...
public class FrontControllerServlet extends HttpServlet {
    ...
    private void injectComponents(Controller component, Class<? extends Controller> componentClass) {
        Stream.of(componentClass.getDeclaredFields()).filter(field -> {
            ...
            Object injectObjetc = ComponentContext.getInstance().getComponent(resoureName);
    ...
    private void println() {
        for (Map.Entry<String, Controller> entry : controllersMapping.entrySet()) {
            servletContext.log("key = " + entry.getKey() + ", value = " + entry.getValue().getClass());
        }

        for (Map.Entry<String, HandlerMethodInfo> entry : handleMethodInfoMapping.entrySet()) {
            servletContext.log("key = " + entry.getKey() + ", value = " + entry.getValue().toString());
        }
    }
