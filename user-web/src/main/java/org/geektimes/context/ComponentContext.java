...
//    }
    ...
    public void init(ServletContext servletContext) throws RuntimeException{
        ...
        servletContext.log("componentContext init env");
        initEnvContext();
        servletContext.log("componentContext init instantiateComponents");
        instantiateComponents();
        servletContext.log("componentContext init initializeComponents");
        servletContext.log("componentsMap != null " +(componentsMap != null));
        initializeComponents();
        servletContext.log("componentContext over");

        // 验证
        Object o = null;
        try {
            o = envContext.lookup("bean/UserService");
        } catch (NamingException e) {
            e.printStackTrace();
        }
        servletContext.log("userService in ioc : " + (o != null));
